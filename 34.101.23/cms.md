...
[Приложение А (обязательное) Модули АСН.1](#app1)

[Приложение Б (рекомендуемое) Использование криптографических алгоритмов в CMS](#app2)
...
# Приложение Б <a name="app2"></a>(рекомендуемое)
