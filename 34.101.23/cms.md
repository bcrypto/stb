...
информацией об их владельце. Формат структуры определен в [{1}](#ISO/IEC 9594-8:2008) (версия 1)
...
(см. [8.4](#Signed4)) данная строка естественным образом представляется строкой из 48,
72 или 96 октетов.
...
Определенный в [{5}](#PFOK) протокол одностороннего формирования общего ключа МОЖНО
применять для шифрования ключей при создании и обработке конвертованных,
аутентифицируемых и аутентифицируемых конвертованных данных. При этом в
`RecipientInfo` ДОЛЖЕН быть выбран компонент ktri типа
`KeyTransRecipientInfo` (см. [9.4.1](#Enveloped41)).
...
[1] <a name="ISO/IEC 9594-8:2008"></a>ISO/IEC 9594-8:2008 Information 
