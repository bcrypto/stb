...
| Включен компонент `clrs`, и он содержит списки отозванных сертификатов различных типов| 5 |
...
аутентифицированных конвертованных данных (см. раздел [13](#AuthEnveloped)), то 
он определяет алгоритмы одновременного шифрования и имитозащиты. В этом
