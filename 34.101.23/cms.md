...
| Условие                                                                                | Версия |
|----------------------------------------------------------------------------------------|--------|
| Включен компонент `certificates`, и он содержит сертификаты различных типов (например, в `certificates` содержатся как сертификаты открытых ключей, так и атрибутные сертификаты) | 5 |
