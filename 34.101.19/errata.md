...
| Пункт 6.2, абзац 2 | включенов | включено в |
...
| Пункт 6.2.1.11 абзац 3 | сертификацииа | сертификации |
...
| Пункт 6.2.1.13 абзац 7 | ДОЖЕН | ДОЛЖЕН |
| Пункт 6.2.1.13 абзац 8 | ДОЖНА | ДОЛЖНА |
...
| Пункт 7.1.1.1 заголовок | Компонет | Компонент |
...
| Пункт 7.2.3, абзац 4 | сответствующие | соответствующие |
| Пункт 7.2.5, абзац 5 | `dstributionPoint` | `distributionPoint` |
| Пункт 7.3.4, абзац 3 | РЕКОМЕДУЕТСЯ | РЕКОМЕНДУЕТСЯ |
| Пункт 8.1, абзац 1 | соотвествующая | соответствующая |
| Пункт 8.1.1, абзац 1,  перечисление г) | довериия | доверия |
| Пункт 8.1.4, абзац 1,  перечисление iii) | полиики | политики |
| Пункт 8.2, абзац 2 | довериия | доверия |
| Пункт 8.3.2, абзац 1,  перечисление а) | значениия | значения |
| Пункт 9.3, абзац 1 | описанно | описано |
| Пункт 9.5, абзац 2 | ковертировано | конвертировано |
...
| Приложение Б, подраздел Б.2, абзац 16 | определнные | определенные |
| Приложение Г, подраздел Г.2, абзац 1 | предзназначен | предназначен |
| Приложение Г, подраздел Г.2, абзац 7 | Компонены | Компоненты|
| Приложение Г, подраздел Г.2, абзац 7 | совместо | совместно |
