...
Язык XML, определенный в базовой спецификации [[2]](99Biblio.md#XML) и других
...
Правила подписания XML-документов определены в [[5]](99Biblio.md#XML-DSIG) и
...
Для каждой ссылки:
  ...
  - применить модель обработки ссылок, определенную в 
    [[5]](99Biblio.md#XML-DSIG) (пункт 4.4.3.2); 
