...
## 6.2 Базовые атрибуты РЭЦП

### 6.2.1 Атрибут `ContentType`
<!--- 5.7.1; 5.1.1 -->
...
### 6.2.4 Атрибут `SigningCertificate`
<!--- 5.7.3; 5.2.2 -->
...
а также позволяют использовать ограниченный набор
сертификатов для проверки подписи. Ссылка позволяет однозначно
идентифицировать сертификат по хэш-значению. Хэш-значение
вычисляется с помощью алгоритма хэширования, идентификатор
которого указывается в ссылке, от сертификата, закодированного 
по отличительным правилам.
...
### 6.2.5 Атрибут `CommitmentTypeIndication`
<!--- 5.11.1; 5.2.3 -->
...
### 6.2.8 Атрибут `DataObjectFormat`
<!--- ; 5.2.4 XAdES -->
...
### 6.2.10 Атрибут `SignerAttributes`
<!--- 5.11.3; 5.2.6.1 -->
...
- атрибутные сертификаты подписанта;
- утверждения, подписанные третьей стороной.


### 6.2.11 Атрибут `Countersignature`
<!--- 5.9.2; 5.2.7 -->
...
### 6.2.12 Атрибут `ContentTimeStamp`
<!--- 5.11.4; 5.2.8 -->
...
### 6.2.13 Атрибут `AllDataObjectsTimeStamp`
<!--- ; 5.2.8.1 XAdES -->
...
### 6.2.14 Атрибут `IndividualDataObjectsTimeStamp`
<!--- ; 5.2.8.2 XAdES -->
...
### 6.2.15 Атрибут `SignaturePolicyIdentifier`
<!--- 5.8.1; 5.2.9 -->
...
### 6.2.16 Атрибут `SignaturePolicyStore`
<!--- ; 5.2.10 -->
...
### 6.2.17 Атрибут `ContentReference`
<!--- 5.10.1; 5.2.11 -->
...
### 6.2.18 Атрибут `ContentIdentifier`
<!--- 5.10.2; 5.2.12 -->
...
## 6.3 Атрибут штампа времени подписи

### 6.3.1 Атрибут `SignatureTimeStamp`
<!--- 6.1; 5.3 -->
...
## 6.4 Атрибуты для указания проверочных данных


<!--- Атрибуты проверки цепочки сертификатов-->

### 6.4.1 Атрибут `CompleteCertificateReferences`
<!--- 6.2.1; A.1.1.1 -->
...
### 6.4.2 Атрибут `CertificateValues`
<!--- 6.3.3; A.1.1.2 -->
...
### 6.4.3 Атрибут `CompleteRevocationReferences`
<!--- 6.2.2; A.1.2.1 -->
...
### 6.4.4 Атрибут `RevocationValues`
<!--- 6.3.4; A.1.2.2 -->
...
### 6.4.5 Атрибут `AttributeCertificateReferences`
<!--- 6.2.3; A.1.3 -->
...
### 6.4.6 Атрибут `AttributeCertificateValues`
<!--- ; XAdES 5.4.3 -->
...
### 6.4.7 Атрибут `AttributeRevocationReferences`
<!--- 6.2.4; A.1.4 -->
...
### 6.4.8 Атрибут `AttributeRevocationValues`
<!--- ; XAdES 5.4.4 -->
...
### 6.4.9 Атрибут `RefsOnlyTimeStamp`
<!--- 6.3.6; A.1.5.1 -->
...
### 6.4.10 Атрибут `SigAndRefsTimeStamp`
<!--- 6.3.5; A.1.5.2 -->
...
## 6.5 Атрибуты архивной проверки


### 6.5.1 Атрибут `TimeStampValidationData`
<!--- ; 5.5.2 -->
...
### 6.5.2 Атрибут `ArchiveTimeStamp`
<!--- ; 5.5.3 -->
