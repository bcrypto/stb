...
набора октетов описаны в [11.3.4](#Pades34).

Структура словаря `Sig` определена в таблице 1. В данной таблице, как и во всех
...
согласно требованиям [[18]](99Biblio.md#PDF) (приложение E). Идентификатор может
...
фиксируется добавлением в словарь `extensions` следующего элемента:
...
(см. [11.2.3](#Pades23)) необходимо добавить следующий элемент:
...
PAdES на основе CAdES, к одной или нескольким подписям XAdES в XML-вставках (см.
[11.4](#Pades4)), к встречающимся в документе штампам времени.
