...
| Пункт 11.3.1, абзац 1 | Расширение фиксируется добавлением в словарь `extensions` следущего элемента: | Расширение фиксируется добавлением в словарь `extensions` следующего элемента: |
| Пункт 11.3.5.1, предпоследний абзац | Для указания на использование расширений DSS и DTS в словарь `extensions` (см. 11.2.3) необходимо добавить следущий элемент: | Для указания на использование расширений DSS и DTS в словарь `extensions` (см. 11.2.3) необходимо добавить следующий элемент: |
