# Приложение A. Расширенные профили
...
атрибутов двумя способами, описанными в разделе [XAdES] (прямое и непрямое 
включение).

Процессы управления подписями профиля B-B переносятся на подписи профилей 
E-BES и E-EPES.

Процессы управления подписями профилей B-T и B-LT переносятся на подписи профилей
E-T, E-C, E-X и E-X-L.

Процессы управления подписями профиля B-LTA переносятся на подписи 
профилей E-A (типов 1 и 2).

<!-- todo: данные взяты из [PROCESSES] (annex B). Но там не сказано, 
как проверять E-X-Long --> 

## A.2 Профили, не допускающие ссылки на аттестаты проверки

### A.2.1 Профили E-BES и E-EPES
...
### A.2.3 Профиль E-A типа 1

Профиль E-A типа 1 является аналогом профиля B-LTA.

## A.3 Профили, допускающие ссылки на аттестаты проверки
...
РЭЦП профиля E-A типа 2 формата XAdES ДОЛЖНА содержать атрибут `RenewedDigests`.
