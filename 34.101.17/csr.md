...
### [Приложение В (рекомендуемое) Запрос на получение сертификата 
открытого ключа электронной цифровой подписи согласно СТБ 1176.2](#App3) 
### [Библиография](#Biblio)
...
# Запрос на получение сертификата открытого ключа электронной цифровой 
подписи согласно СТБ 1176.2 
...
первым элементом которой является старший (не-нулевой) бит подписи, 
...
## <a name="App32"></a>В.2 Алгоритмы доказательства владения личным ключом 
протоколов формирования общего ключа 
...
### <a name="App323"></a>В.2.3 Алгоритм проверки доказательства владения 
личным ключом протоколов формирования общего ключа 
