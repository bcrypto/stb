...
СТБ 34.101.80-20XX Информационные технологии и безопасность. Расширенные 
...
выработана до или после отзыва СОК (см. раздел 8 СТБ.34.101.80). Штамп 
...
(см. пункт 9.2.4 СТБ 34.101.80, атрибут описывается либо одноименным типом
...
`SigningCertificate`, ДОЛЖЕН быть предоставлен в компоненте 
...
посредствам передачи файлов, например, по протоколу FTP [[8]](#Biblio8). 
...
случаев, указанных в подразделе 8.2 СТБ 34.101.80. В связи с этим, 
